# ui_components/segment-anything-ui/segment_anything_ui/config.py
import dataclasses
import os
...
THERMAL_API_BASE_URL = "http://localhost:8000/api/"
USE_THERMAL_BACKEND = True
DEFAULT_MODEL = "tiny"  # Matches your optimal config!
